...
const HonourRole = () => {
    ...
    <div>
        ...
        <div className="gossip">
                ...
                <br/>
                <br/>
                <img className="newsImg cartoon" src={p5} alt="law "/>
                <div className="leader">
            ...
            <div className="gossip">
                ...
                <br/>
                <br/>
                <img className="gossipImg cartoon" src={p6} alt="law "/>
                <div className="leader">
                    <h2>2019/2020 Chief Judge</h2>
                    <p className="leader-p">Aigbe Halima Amalohi</p>
                    <p className="leader-p">LinkedIn Profile- Halima Aigbe, Instagram- leemah_ama</p>
        ...
        <div className="gossip">
                ...
                <br/>
                <br/>
                <img className="newsImg cartoon" src={p7} alt="law "/>
                <div className="leader">
                    <h2>2015/2016 Chief Judge</h2>
                    <p className="leader-p"> Bolloite Deborah Offor</p>
                    <p className="leader-p"> LinkedIn: Bolloite Deborah Offor</p>
                </div>
            </div>
