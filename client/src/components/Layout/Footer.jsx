...
const Footer = () =>{
   ...
   <div className="bottom-container">
     ...
     <a href="tel:+2348093963988"className="footer-link" target="_blank" rel="noopener noreferrer">Contact</a> 
     <a className="footer-link" href="mailto:lssabuad@gmail.com?subject=CONTACT MESSAGE FROM YOUR LSS WEBSITE" target="_blank " rel="noopener noreferrer">Email</a>
