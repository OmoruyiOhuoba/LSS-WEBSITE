...
const Footer = () =>{
   ...
   <div className="bottom-container">
     ...
     <a href="tel:+2349083896328"className="footer-link" target="_blank" rel="noopener noreferrer">Contact</a> 
     ...
     <a href="https://www.twitter.com/lssabuad" className="footer-link" target="_blank" rel="noopener noreferrer">Twitter</a>
     ...
     <a href="https://www.instagram.com/lssabuad/"  className="footer-link" target="_blank " rel="noopener noreferrer">Instagram</a>
     <p className="last">© {new Date().getFullYear()} Made by <span className="last-last"><a href="http://www.omoruyiohuoba.com/" class="last-last">Omoruyi Ohuoba.</a></span> All Rights Reserved.</p>
   </div>
        )
}
